...
C {devices/lab_pin.sym} -390 -580 0 1 {name=l12 sig_type=std_logic lab=VC}
C {devices/lab_wire.sym} 440 -530 1 1 {name=l11 sig_type=std_logic lab=IBP_1U[0]}
C {devices/lab_wire.sym} 420 -530 1 1 {name=l14 sig_type=std_logic lab=IBP_1U[1]}
C {devices/lab_wire.sym} 400 -530 1 1 {name=l15 sig_type=std_logic lab=IBP_1U[2]}
C {devices/lab_wire.sym} 380 -530 1 1 {name=l16 sig_type=std_logic lab=IBP_1U[3]}
C {devices/opin.sym} 340 -560 1 0 {name=p3 lab=IBP_1U_A}
C {devices/opin.sym} 10 -510 1 0 {name=p5 lab=IBP_A}
C {devices/opin.sym} 80 -510 1 0 {name=p6 lab=IBP_B}
C {devices/ipin.sym} 40 -510 3 0 {name=p7 lab=IBP_G}
...
C {devices/ipin.sym} -230 -780 0 0 {name=p10 lab=PWRUP_N_1V8}
...
C {RPLY_BIAS_SKY130NM/RPLYBS_PMIRR.sym} -70 -810 0 0 {name=x5 }
